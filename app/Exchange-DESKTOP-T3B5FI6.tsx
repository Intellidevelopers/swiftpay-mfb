...
const options = [
  {
    ...
    route: '/TradingScreen' as Href,  // Ensure correct type
  },
  {
    id: '2',
    title: 'Buy Cryptocurrency',
    description: 'Make your Crypto purchase swiftly, paste your wallet address and we’ll do the rest...',
    image: require('../assets/icons/dollar.png'),  // Replace with your actual image path
    route: '/buy-cryptocurrency' as Href,  // Ensure correct type
  },
  {
    id: '3',
    ...
    image: require('../assets/icons/dollar.png'),  // Replace with your actual image path
    route: '/buy-gift-cards' as Href,  // Ensure correct type
  },
];
...
const Exchange: React.FC<ExchangeProps> = ({ navigation }) => {
