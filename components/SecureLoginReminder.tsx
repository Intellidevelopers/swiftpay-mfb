...
const SecureLoginReminder: React.FC<{ visible: boolean; onClose: () => void }> = ({ visible, onClose }) => {
  return (
    <Modal
      transparent
      visible={visible}
      ...
      <View style={styles.overlay}>
        <View style={styles.container}>
          ...
          <View style={styles.buttonContainer}>
            <Pressable style={styles.buttonOutline} onPress={() => alert('Reset Password')}>
              <Text style={styles.buttonOutlineText}>Reset Password</Text>
            </Pressable>
            <Pressable style={styles.buttonSolid} onPress={() => alert('Re-Login')}>
