...
const BureauDeChangeSell: React.FC<ExchangeProps> = ({ navigation }) => {
  ...
  const filteredSell = Sell.filter((Sell) =>
    activeStatus2 === 'USD' ? true : Sell.status === activeStatus2
  );
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.tabContainer}>
        ...
        >
          <Text style={activeTab === 'Sell' ? styles.activeTabText : styles.tabText}>Sell</Text>
        </TouchableOpacity>
        <TouchableOpacity
