  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Text style={styles.descriptionText}>
        Enter email, a code will be sent to your email to continue, to reset password
      </Text>
      ...
      <Modal visible={packageModalVisible}  transparent={true} animationType="fade">
        <Pressable style={styles.modalOverlay} onPress={() => setPackageModalVisible(false)} >
          <View style={styles.modalContainer}>
            <Image source={require('../assets/icons/mail.png')} style={styles.logo}/>
            <Text style={styles.title}>Code Sent</Text>
            <Text style={styles.subTitle}>An OTP code has been sent to the email you entered.</Text>
