  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.receiptContainer}>
        ...
        <Text style={styles.successText}><AntDesign name='checkcircle'/> successful</Text>
      ...
      <View style={styles.detailsContainer}>
        ...
        <TransactionDetailItem label="Transaction Number" value="3684024832376324" />
        <TransactionDetailItem label="Transaction Date" value="3/3/2023 23:00" />
      </View>
...
const TransactionSummaryItem = ({ label, value }: { label: string; value: string }) => (
...
const TransactionDetailItem = ({ label, value }: { label: string; value: string }) => (
