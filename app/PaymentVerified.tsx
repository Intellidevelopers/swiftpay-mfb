  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        <Image source={require('../assets/icons/verified.png')} style={styles.icon} />
        <Text style={styles.title}>Payment Verified</Text>
        <Text style={styles.description}>Redirecting you back to the home page, funds credited to your SwiftPay Account</Text>
      </View>
    </View>
  )
}
