  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.optionsContainer}>
        <TouchableOpacity style={styles.optionCard} onPress={() => router.push('/CreditCard')}>
          <View style={styles.optionContent}>
            <Image source={require('../assets/cards/card.png')} style={styles.optionIcon} />
        ...
        <TouchableOpacity style={styles.optionCard} onPress={() => router.push('/')}>
          <View style={styles.optionContent}>
            <Image source={require('../assets/cards/bank.png')} style={styles.optionIcon} />
