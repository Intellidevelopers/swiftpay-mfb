...
const SellGiftcard: React.FC<ExchangeProps> = ({ navigation }) => {
  ...
  const [selectedCardCategoryIcon, setSelectedCardCategoryIcon] = useState<any>(null);  // Store the selected card's icon
  ...
  const cardTypeOptions = [
    { label: 'Apple/iTunes Gift Card', value: 'apple', icon: require('../assets/icons/apple.png') },
    { label: 'Amazon Gift Card', value: 'amazon', icon: require('../assets/icons/amazon.png') },
    { label: 'Google Play Gift Card', value: 'google', icon: require('../assets/icons/apple.png') },
  ];

  const cardCategoryOptions = [
    { label: 'Belgium Apple Tunes/iTunes Physical', value: 'Belgium Apple Tunes/iTunes Physical', icon: require('../assets/icons/amazon.png') },
    { label: 'Belgium Apple Tunes/iTunes Physical', value: 'Belgium Apple Tunes/iTunes Virtual', icon: require('../assets/icons/amazon.png') },
  ];
  ...
  const navigateToSellScreen = (cryptoDetails: { name: string; price: string; quantity: string; limits: string }) => {
    router.push({
      pathname: '/SellBtc',
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Text style={styles.desc}>Kindly provide correct details of the card</Text>

      {/* Tabs */}
      <View style={styles.tabContainer}>
        <Text style={styles.filterText}>Filter by:</Text>
        <TouchableOpacity
          style={activeTab === 'Sell' ? styles.activeTabButton : styles.tabButton}
          onPress={() => setActiveTab('Sell')}
        >
          <Text style={activeTab === 'Sell' ? styles.activeTabText : styles.tabText}>Physical</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={activeTab === 'History' ? styles.activeTabButton : styles.tabButton}
          onPress={() => setActiveTab('History')}
        >
          <Text style={activeTab === 'History' ? styles.activeTabText : styles.tabText}>E-code</Text>
        </TouchableOpacity>
      </View>
      ...
      {activeTab === 'Sell' ? (
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
         ...
         <TouchableOpacity style={styles.dropdownContainer} onPress={() => setCardTypeModalVisible(true)}>
          <View style={styles.dropdownItems}>
            {selectedCardIcon && <Image source={selectedCardIcon} style={styles.icon} />}
            <Text>{selectedCardType ? selectedCardType : 'Select Card Type'}</Text>
          </View>
          <AntDesign name='down' size={20} />
        </TouchableOpacity>

         <Text style={styles.label}>Select Card Category</Text>
         <TouchableOpacity style={styles.dropdownContainer} onPress={() => setCardCategoryModalVisible(true)}>
          <View style={styles.dropdownItems}>
          {selectedCardCategoryIcon && <Image source={selectedCardCategoryIcon} style={styles.icon} />}
            <Text>{selectedCardCategory ? selectedCardCategory : 'Select Card Category'}</Text>
          </View>
          <AntDesign name='down' size={20} />
        </TouchableOpacity>
         ...
         <TextInput
            ...
            <TouchableOpacity style={styles.balanceContainer}>
              <Text style={styles.balance}><Text style={{color: "#1400FB", fontWeight: "400",}}>Rate:</Text> ₦ 4,890.00</Text>
            </TouchableOpacity>
          </View>
      ...
      />
        ...
        <View style={{ flexDirection: "row", alignItems: "center" }}>
            ...
            <TouchableOpacity
            style={[styles.proceedButton, !giftCardAmount && styles.disabledButton]}
      ...
      <Modal visible={isCardTypeModalVisible} transparent animationType="slide">
        ...
        <Modal visible={isCardCategoryModalVisible} transparent animationType="slide">
          <View style={styles.modalContainer}>
            <View style={styles.modalContent}>
