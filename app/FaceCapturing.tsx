...
import { StyleSheet, Text, View, TouchableOpacity, Image, StatusBar, Modal } from 'react-native';
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.instructionsContainer}>
        ...
        <Text style={styles.instructionsText}>1. Your head must be in the middle of the photograph.</Text>
        <Text style={styles.instructionsText}>2. No sunglasses, headwear, or face painting.</Text>
        <Text style={styles.instructionsText}>3. You must be facing forward with a neutral expression (no smiling).</Text>
        <Text style={styles.instructionsText}>4. Please make sure you are in a well-lit area.</Text>
      </View>
      {photoUri ? (
        <>
