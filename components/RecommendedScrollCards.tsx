...
const data: DataOffer[] = [
  { id: '1', plan: '3GB/2days/50%Off', amount: '400.00', strikedAmount: '800.00', status: 'Sold Out' },
  { id: '2', plan: '5GB/3days/30%Off', amount: '600.00', strikedAmount: '900.00', status: 'Sold Out' },
  { id: '3', plan: '10GB/7days/40%Off', amount: '1200.00', strikedAmount: '2000.00', status: 'Sold Out' },
  { id: '4', plan: '10GB/7days/40%Off', amount: '1200.00', strikedAmount: '2000.00', status: 'Available' },
    ...
    <View style={styles.card}>
      ...
      <View style={styles.statusContainer}>
        <View
          style={[
            styles.status,
            { backgroundColor: item.status === 'Available' ? '#0cbc8b' : '#cdb9fb' } // Green for 'Available', purple for others
          ]}
        ></View>
