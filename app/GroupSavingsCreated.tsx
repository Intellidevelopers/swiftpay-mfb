...
import { View, Text, StyleSheet, TouchableOpacity, Clipboard, ToastAndroid, Image, StatusBar } from 'react-native';
import { useNavigation } from '@react-navigation/native';
import { router } from 'expo-router';

const GroupSavingsCreated = () => {
...
<StatusBar backgroundColor={'#f5f5f5'}/>
      <View style={styles.content}>
        ...
        <Text style={styles.title}>GROUP SAVINGS CREATED</Text>
        ...
        <TouchableOpacity style={styles.proceedButton} onPress={handleProceedToGroup}>
...
export default GroupSavingsCreated;
