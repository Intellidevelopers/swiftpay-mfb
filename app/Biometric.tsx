...
const Biometric = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subtitle}>Please activate your {biometricType?.toLowerCase() || 'biometric'}</Text>
      <Image source={require('../assets/logos/fingerprint.png')} style={styles.image} />
