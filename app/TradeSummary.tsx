    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.paymentDetailsContainer}>
        ...
        <Text style={styles.desc2}>
          ...
          wrong (sub)category. To be safe please read the terms below properly.
        </Text>
      </View>
      ...
      <Text style={styles.desc3}>
        ...
        iTunes gift card purchased from the store. iTunes gift card codes start
        with X and are 16-digits.
      </Text>
